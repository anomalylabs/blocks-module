...
You can use any of the built in sections:
...
You can also resolve the `\Anomaly\BlocksModule\Block\BlockCategories` class and use the `register` method to add a category of your own:
